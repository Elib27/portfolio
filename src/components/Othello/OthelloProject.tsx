  ...
  return (
    <Show when={isProjectOpen()} fallback={<button class={styles.projectButton} onClick={() => setIsProjectOpen(true)}>Un dernier projet ?</button>}>
      <div class={styles.projectWrapper}>
        ...
        <p class={styles.description}>Une implémentation d&apos;une IA jouant au jeu Othello, dont l&apos;objectif est d&apos;avoir le plus de pions de votre couleur sur le plateau à la fin de la partie. 
        ...
        Elle est executée sur un web worker pour ne pas entraver la fluidité de la page durant le calcul du prochain coup. 
