...
**Lesson learned:** my first dataset iteration used only 9 repos and was less strict on one of the rules (e.g too many repetitions) — not enough diversity. The current dataset has 13.
